...
import { contactForm, contactForm__success, contactForm__content, contactForm__text, contactForm__form, contactForm__fields, contactForm__button } from "./style.module.scss"
